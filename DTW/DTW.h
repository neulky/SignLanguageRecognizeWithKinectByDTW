...
int DTWOptimalPath(point * M, int I, point * T, int J, float threshold, int turn, int hand_flag);   //寻找并显示DTW路径
int DTWUpdataModule(point * new_module, int newModuleFrameNum, int hand_flag);  //更新DTW模板中数据
